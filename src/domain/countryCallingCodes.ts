...
export const COUNTRY_CALLING_CODES: CountryCallingCode[] = [
  ...
  { name: 'Antigua & Barbuda', code: '+1 268', iso: 'AG' },
  ...
  { name: 'Heard & McDonald Islands', code: '+672', iso: 'HM' },
  { name: 'Honduras', code: '+504', iso: 'HN' },
  { name: 'Hong Kong SAR China', code: '+852', iso: 'HK' },
  ...
  { name: 'Macao SAR China', code: '+853', iso: 'MO' },
  ...
  { name: 'Palestinian Territories', code: '+970', iso: 'PS' },
  ...
  { name: 'São Tomé & Príncipe', code: '+239', iso: 'ST' },
  ...
  { name: 'St. Barthélemy', code: '+590', iso: 'BL' },
  { name: 'St. Helena', code: '+290', iso: 'SH' },
  { name: 'St. Kitts & Nevis', code: '+1 869', iso: 'KN' },
  { name: 'St. Lucia', code: '+1 758', iso: 'LC' },
  { name: 'St. Martin', code: '+590', iso: 'MF' },
  { name: 'St. Pierre & Miquelon', code: '+508', iso: 'PM' },
  { name: 'St. Vincent & Grenadines', code: '+1 784', iso: 'VC' },
  { name: 'Sudan', code: '+249', iso: 'SD' },
  { name: 'Suriname', code: '+597', iso: 'SR' },
  { name: 'Svalbard & Jan Mayen', code: '+47', iso: 'SJ' },
  ...
  { name: 'Turks & Caicos Islands', code: '+1 649', iso: 'TC' },
  { name: 'Tuvalu', code: '+688', iso: 'TV' },
  { name: 'U.S. Outlying Islands', code: '+1', iso: 'UM' },
  ...
  { name: 'Wallis & Futuna', code: '+681', iso: 'WF' },
