...
export interface Profile { name: string; mobile: string; emergencyMobile?: string }
...
export interface Settings { onboarded: boolean; notifications: boolean; appLock: boolean; localShareState: 'once' | '24h' | 'until-revoked'; theme?: 'light' | 'dark' }
